-- =============================================================
-- Step 2 of 2: Enforce 2× Cap + Update distribute_daily_roi()
-- Run this AFTER migration_step1_add_enum.sql has completed
-- =============================================================

-- ─── Retroactive 2× cap enforcement ───
...
-- ─── Complete any slots sitting exactly at the cap ───
UPDATE public.slot_bookings
SET status = 'completed'
WHERE status IN ('active', 'confirmed')
  AND total_earned >= amount * 2;

-- ─── Deploy updated distribute_daily_roi() with 2× cap ───
